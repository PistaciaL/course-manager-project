  ...
  <div class="container">
    ...
    <div class="table-container">
      <el-table :data="courses" style="width: 100%">
        ...
        <el-table-column label="开课学期" min-width="160">
          <div
            slot-scope="scope"
            @click="
              searchBy('term', {
        ...
        <el-table-column label="申请补选" width="120">
          <div slot-scope="scope">
            <el-button @click="showApplyForm(scope.row.id)" size="small"
              >我要补选</el-button
            >
            <el-dialog title="我要补选" :visible.sync="applyFormShow">
              <el-form
                :model="applyForm"
                :rules="applyFormRules"
                ref="applyForm"
              >
                <el-form-item label="补选理由" prop="content">
                  <el-input
                    type="textarea"
                    autosize
                    placeholder="请输入内容"
